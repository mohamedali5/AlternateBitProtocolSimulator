...
#define SENDER_INPUT_FILE_PATH "test/data/sender_input_test_control_In.txt"
#define SENDER_ACK_FILE_PATH "test/data/sender_input_test_ack_In.txt"
#define SENDER_OUTPUT_FILE_PATH "test/data/sender_test_output.txt"
#define SENDER_TRANSFORM_OUTPUT_FILE_PATH "test/data/sender_test_output_transform.txt"
...
int main() {
    ...
    const char *output_file = SENDER_OUTPUT_FILE_PATH;
    const char *transform_output_file = SENDER_TRANSFORM_OUTPUT_FILE_PATH; 
     ...
     */
    string input_data_control = SENDER_INPUT_FILE_PATH;
     ...
     * runs the execution for number of input times 
     */
    string input_data_ack = SENDER_ACK_FILE_PATH;
