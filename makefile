...
# TO RUN SIMULATOR
simulation: build/top_model/main.o build/message.o
	$(CC) -g -o bin/top_model/ABP build/top_model/main.o build/message.o

# TO RUN SENDER, RECEIVER, SUBNET 
test: build/test/main_sender.o build/test/main_receiver.o build/test/main_subnet.o build/message.o
	$(CC) -g -o bin/test/RECEIVER_TEST build/test/main_receiver.o build/message.o
	$(CC) -g -o bin/test/SENDER_TEST build/test/main_sender.o build/message.o
	$(CC) -g -o bin/test/SUBNET_TEST build/test/main_subnet.o build/message.o
